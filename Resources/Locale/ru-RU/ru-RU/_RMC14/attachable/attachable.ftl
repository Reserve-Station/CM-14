...
attachable-popup-activate-deploy-on-generic = Вы размещаете { THE($attachable) } на { THE($surface) }.
attachable-popup-activate-deploy-on-ground = Вы размещаете { THE($attachable) } на земле.
...
attachable-popup-deactivate-collapse = Вы сворачиваете { THE($attachable) }.
attachable-popup-activate-lock = Вы запираете { THE($attachable) }.
...
rmc-attachable-examine-condition-active = { THE($attachable) } является [bold]активным[/bold].
rmc-attachable-examine-condition-inactive = { THE($attachable) } является [bold]неактивным[/bold].
